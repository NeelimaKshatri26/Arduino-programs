...
char ssid[] = "vivo Y21";   // your network SSID (name) 
char pass[] = "bhavana2003";    // your network password
...
void loop() {
    ...
    statusCode = ThingSpeak.readMultipleFields(2220442,myChannelReadAPIKey);
    
    if(statusCode == 200)
    {
      // Fetch the stored data

      int x = ThingSpeak.getFieldAsInt(1); // Field 1
      int y=ThingSpeak.getFieldAsInt(2);
      Serial.println("the value of field 1 is:" + String(x));
